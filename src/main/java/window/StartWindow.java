...
public class StartWindow implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        if (this.accountingSystem != null){
            this.accountingSystem = accountingSystemHib.getById(accountingSystem.getId());
        }
    }
    ...
    public void setEntityManagerFactory(EntityManagerFactory entityManagerFactory) {
        AccountingSystemHib accountingSystemHib = new AccountingSystemHib(entityManagerFactory);
        this.accountingSystem = accountingSystemHib.getByName("System");
